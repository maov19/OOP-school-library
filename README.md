...
**[OOPSL]** is a backend database tool to record books in the library and who borrows them. 
...
```bash
git clone https://github.com/maov19/OOP-school-library/
```
...
## 💻 Getting Started <a name="author"></a>
